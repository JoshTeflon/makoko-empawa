...
const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  const cardWidth = "w-full max-w-[14.5rem] md:max-w-[18.5rem] lg:max-w-[22rem]";
  ...
  return (
    ...
    >
      ...
      <div className={clsx(cardWidth, "absolute bottom-2.5 md:bottom-4 lg:bottom-5 right-8 md:right-12 lg:right-[3.75rem]")}>
        ...
        <div
          className="py-3 lg:py-5 px-2.5 lg:px-4 w-full h-[7.75rem] md:h-[8.75rem] lg:h-[9.5rem] bg-primary text-white rounded-[0.625rem] shadow-testimonialCard overflow-hidden"
        >
          {note}
        </div>
      </div>
